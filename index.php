...
if ($_SERVER['REQUEST_METHOD'] == "POST") { // if method from the form Post wii do the delete and edit and add
    ...
    if (isset($_POST['del'])) {
        ...
        header("Location: index.php"); // update the page after store array Book in the seesion
        exit;
        ...
        header("Location: index.php"); // update the page
        exit;
    }
}
    ...
    <div class="container"><!--  i used container Becouse it will put the iteams in the center -->
        ...
        <div class="row gx-5">
            <div class="col-md-4">
                ...
                <?php if ($success): ?>
                    <div class="alert alert-success alert-dismissible fade show py-1.8">
                        <?php echo $success; ?>
